...
class FutureDeatailTest(ParametrizedTestCase):
    ...
    # 修改抬头设置
    def testQDetaillMoreSettingTTModify2(self):
        app = {}
        app["logTest"] = self.logTest
        app["driver"] = self.driver
        app["path"] = PATH("../yaml/detail/QDetaillMoreSettingTTModify2.yaml")
        app["device"] = self.devicesName
        app["caseName"] = sys._getframe().f_code.co_name
        page = BasePage(app)
        page.operate()
    ...
    # 修改默认设置
    def testSDetaillMSettingZTCSXGModify(self):
        app = {}
        app["logTest"] = self.logTest
        app["driver"] = self.driver
        app["path"] = PATH("../yaml/detail/SDetaillMSettingZTCSXGModify.yaml")
        app["device"] = self.devicesName
        app["caseName"] = sys._getframe().f_code.co_name
        page = BasePage(app)
        page.operate()
    ...
    # 重置默认设置
    def testTDetaillMSettingZTCSXGReplace(self):
        app = {}
        app["logTest"] = self.logTest
        app["driver"] = self.driver
        app["path"] = PATH("../yaml/detail/TDetaillMSettingZTCSXGReplace.yaml")
        app["device"] = self.devicesName
        app["caseName"] = sys._getframe().f_code.co_name
        page = BasePage(app)
        page.operate()
